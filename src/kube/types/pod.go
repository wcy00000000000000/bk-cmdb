...
// ListKubeContainerInBizSetResp is the list kube container in biz set response
type ListKubeContainerInBizSetResp struct {
	metadata.BaseResp `json:",inline"`
	Data              ListKubeContainerInBizSetData `json:"data"`
}

// ListKubeContainerInBizSetData is the list kube container in biz set data
type ListKubeContainerInBizSetData struct {
	Count int64                          `json:"count"`
	Info  []ListKubeContainerInBizSetRes `json:"info"`
}
